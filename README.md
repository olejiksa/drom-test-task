...
Разработать приложение на Objective-C для iPhone без использования Interface Builder, версия iOS 9.0+, без использования сторонних фреймворков, только iOS SDK.
